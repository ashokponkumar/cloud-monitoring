...
1. Sie müssen ein Mitglied oder ein Eigner eines {{site.data.keyword.Bluemix_notm}}-Kontos mit Berechtigungen zum Bereitstellen von Services in einem Bereich, Implementieren von CF-Apps und Abfragen von Metriken in {{site.data.keyword.Bluemix_notm}} über den {{site.data.keyword.monitoringshort}}-Service sein.
    ...
    Weitere Informationen finden Sie unter [Einem Benutzer eine CF-Rolle über die IBM Cloud-Benutzerschnittstelle zuweisen](/docs/services/cloud-monitoring/security/grant_permissions.html#grant_permissions_ui_space).
