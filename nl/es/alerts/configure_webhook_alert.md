...
Para poder invocar un webhook, el campo *detail* debe establecerse en el URL en el que debe realizar la acción POST. Configure un webhook para puntos finales https y añada un parámetro.
