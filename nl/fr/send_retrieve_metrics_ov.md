...
Vous pouvez envoyer des métriques à un espace à l'aide de l'API Metrics ou en configurant le plug-in {{site.data.keyword.monitoringshort}}, qui est un plug-in collectd. Vous pouvez extraire des métriques à à l'aide de l'API Metrics.
{:shortdesc}
...
* Vous pouvez utiliser l'appel API `Endpoint/v1/metrics/list` où Endpoint représente le point d'entrée du service. 
